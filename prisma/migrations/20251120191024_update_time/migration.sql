...
*/
-- AlterTable
ALTER TABLE `ProductStats` MODIFY `syncTime` DATETIME(3) NOT NULL;

-- AlterTable
ALTER TABLE `RoomStats` MODIFY `createdAt` DATETIME(3) NOT NULL;

-- AlterTable
ALTER TABLE `SalesStats` MODIFY `syncTime` DATETIME(3) NOT NULL;
